          ...
          <RevealOnScroll>
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">
                Interactive multiplayer Tic-Tac-Toe game with custom player registration, real-time turn tracking, and dynamic win detection. Built with vanilla JavaScript, featuring glassmorphism UI design, responsive layout, and smooth animations
              </p>
            ...
            "
            >
              <h3 className="text-xl font-bold mb-2">PROJECTS 3</h3>
              <p className="text-gray-400 mb-4">
                des
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
            ...
            "
            >
              <h3 className="text-xl font-bold mb-2">PROJECTS 4</h3>
              <p className="text-gray-400 mb-4">
                des
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
